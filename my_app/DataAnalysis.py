...
class Vectorization:
    def __init__(self):
        ...
        self.stop_words_list_ge = (
            line.strip()
            for line in open(self.stop_words_list_path, 'r', encoding='gb18030',errors='ignore').readlines())
        for wd in self.stop_words_list_ge:
            self.stop_words_list.append(wd)
        # 打开Similarity.csv
        self.sim_list_path = self.source_path + 'demo60_Similarity.csv'
        self.sim_list = []
        with open(self.sim_list_path,encoding='gb18030',errors='ignore') as f:
            reader = csv.reader(f)
        ...
        self.sug_list = []
        with open(self.sug_list_path , encoding='utf-8',errors='ignore') as f:
            reader = csv.reader(f)
    ...
    def get_format_matrix(self, ori_string):
        ...
        format_matrix = []
        with open(standard_list_path,encoding='gb18030',errors='ignore') as f:
            reader = csv.reader(f)
